...
enum client_proxy_protocol_type {
	CLIENT_ENTRY_PROXY_PROTOCOL_WITHOUT = 0,
	CLIENT_ENTRY_PROXY_PROTOCOL_WITH = 1,
	CLIENT_ENTRY_PROXY_PROTOCOL_ANY = 2
};
...
struct exportlist_client_entry {
	...
	enum client_proxy_protocol_type proxy_protocol_type;
};

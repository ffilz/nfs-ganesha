...
#define ACCESS_CHECK_POLICY_ALL \
	(ACCESS_CHECK_POLICY_PRE | ACCESS_CHECK_POLICY_POST)

#define READ_ACCESS_CHECK_POLICY_PRE ACCESS_CHECK_POLICY_PRE
#define READ_ACCESS_CHECK_POLICY_POST ACCESS_CHECK_POLICY_POST
#define READ_ACCESS_CHECK_POLICY_ALL ACCESS_CHECK_POLICY_ALL

#define LOOKUP_ACCESS_CHECK_POLICY_PRE ACCESS_CHECK_POLICY_PRE
#define LOOKUP_ACCESS_CHECK_POLICY_POST ACCESS_CHECK_POLICY_POST
#define LOOKUP_ACCESS_CHECK_POLICY_ALL ACCESS_CHECK_POLICY_ALL

#define READDIR_ACCESS_CHECK_POLICY_PRE ACCESS_CHECK_POLICY_PRE
#define READDIR_ACCESS_CHECK_POLICY_POST ACCESS_CHECK_POLICY_POST
#define READDIR_ACCESS_CHECK_POLICY_ALL ACCESS_CHECK_POLICY_ALL

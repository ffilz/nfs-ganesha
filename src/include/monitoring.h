 ...
 * Broken monitoring should not affect serving.
 */
...
void monitoring_rpc_processed(void);

// Client stats from op_ctx->client.
void monitoring_client_activity(const char *client_ip);

...
/* Array reply macro for all clients stats - wraps CE_STATS_REPLY in array format */
...
#define CLNT_V4_OPS_REPLY \
	{ .name = "clnt_v4_ops_stats", .type = CLNT_V4_OPS_TYPE, .direction = "out" }

#define CLNT_CMP_OPS_TYPE "ttt"
#define CLNT_CMP_OPS_REPLY \
	{ .name = "clnt_cmp_ops_stats", .type = CLNT_CMP_OPS_TYPE, .direction = "out" }

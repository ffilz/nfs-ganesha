...
#define QOS_MAX_BW (4UL * 1024 * 1024 * 1024) /* 4GBps */
...
#define QOS_MAX_IOPS (4 * 1024 * 4) /* 4op per MB * GB* 4 = 4GBps  */
#define QOS_DEFAULT_EXPORT_IOPS (4 * 1024 * 2) /* 4op per MB * GB* 2 = 2GBps  */
#define QOS_DEFAULT_CLIENT_IOPS (4 * 1024 * 2) /* 4op per MB * GB* 2 = 2GBps */

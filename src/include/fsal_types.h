...
#define IS_FSAL_ACE_SPECIAL(ACE)                                             \
	(IS_FSAL_ACE_SPECIAL_OWNER(ACE) || IS_FSAL_ACE_SPECIAL_GROUP(ACE) || \
	 IS_FSAL_ACE_SPECIAL_EVERYONE(ACE))

/* Macros for internal NFS4 ACE flags. */

#define IS_FSAL_ACE_MODE_GEN(ACE) \
	IS_FSAL_ACE_BIT(GET_FSAL_ACE_IFLAG(ACE), FSAL_ACE_IFLAG_MODE_GEN)
...
#define FSAL_FD_INIT                                                                             \
	{                                                                                        \
		...
		.fsal_export = op_ctx->fsal_export, .fd_lru = { NULL, NULL },                    \
		/* work_mutex unused for FSAL_FD_TEMP */ /* work_cond unused for FSAL_FD_TEMP */ \

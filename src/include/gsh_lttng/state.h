...
#if !defined(GANESHA_LTTNG_STATE_TP_H) || defined(TRACEPOINT_HEADER_MULTI_READ)
...
TRACEPOINT_EVENT(
	state, add,
	TP_ARGS(const char *, function, int, line, void *, obj, void *, state),
...
TRACEPOINT_LOGLEVEL(state, add, TRACE_INFO)
...
TRACEPOINT_LOGLEVEL(state, delete, TRACE_INFO)

...
#define GRPC_SERVER_CERTIFICATE "/etc/ganesha/ganesha_grpc_tls_cert/server.crt"
#define GRPC_SERVER_KEY "/etc/ganesha/ganesha_grpc_tls_cert/server.key"
#define GRPC_CLIENT_CERTIFICATE "/etc/ganesha/ganesha_grpc_tls_cert/client.crt"
#define GRPC_CLIENT_KEY "/etc/ganesha/ganesha_grpc_tls_cert/client.key"
#define GRPC_CA_CERTIFICATE "/etc/ganesha/ganesha_grpc_tls_cert/ca.crt"

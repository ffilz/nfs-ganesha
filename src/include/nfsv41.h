...
static inline bool xdr_LISTXATTR4res(XDR *xdrs, LISTXATTR4res *objp)
{
	...
	switch (objp->status) {
	case NFS4_OK:
		if (!xdr_LISTXATTR4resok(xdrs,
		     &objp->LISTXATTR4res_u.resok4))
			return false;
		break;
	default:
		break;
...
static inline bool xdr_GETATTR4res(XDR *xdrs, GETATTR4res *objp)
{
	...
	switch (objp->status) {
	case NFS4_OK:
		if (!xdr_GETATTR4resok(xdrs,
		     &objp->GETATTR4res_u.resok4))
			return false;
		break;
	default:
		break;
...
static inline bool xdr_locker4(XDR *xdrs, locker4 *objp)
{
	...
	case true:
		if (!xdr_open_to_lock_owner4(xdrs,
		     &objp->locker4_u.open_owner))
			return false;
		break;
	case false:
		if (!xdr_exist_lock_owner4(xdrs,
		     &objp->locker4_u.lock_owner))
			return false;
		break;
	default:
		return false;
...
static inline bool xdr_READDIR4res(XDR *xdrs, READDIR4res *objp)
{
	...
	switch (objp->status) {
	case NFS4_OK:
		if (!xdr_READDIR4resok(xdrs,
		     &objp->READDIR4res_u.resok4))
			return false;
		break;
	default:
		break;
...
static inline bool xdr_READLINK4res(XDR *xdrs, READLINK4res *objp)
{
	...
	switch (objp->status) {
	case NFS4_OK:
		if (!xdr_READLINK4resok(xdrs,
		     &objp->READLINK4res_u.resok4))
			return false;
		break;
	default:
		break;
...
static inline bool xdr_SEQUENCE4res(XDR *xdrs, SEQUENCE4res *objp)
{
	...
	case NFS4_OK:
		if (!xdr_SEQUENCE4resok(xdrs,
		     &objp->SEQUENCE4res_u.sr_resok4))
			return false;
		break;
	default:
		break;
...
static inline bool xdr_SET_SSV4res(XDR *xdrs, SET_SSV4res *objp)
{
	...
	case NFS4_OK:
		if (!xdr_SET_SSV4resok(xdrs,
		     &objp->SET_SSV4res_u.ssr_resok4))
			return false;
		break;
	default:
		break;
...
static inline bool xdr_nfs_argop4(XDR *xdrs, nfs_argop4 *objp)
{
	...
	switch (objp->argop) {
	case NFS4_OP_ACCESS:
		if (!xdr_ACCESS4args(xdrs,
		     &objp->nfs_argop4_u.opaccess))
			return false;
		break;
	case NFS4_OP_CLOSE:
		...
		break;
	case NFS4_OP_COMMIT:
		if (!xdr_COMMIT4args(xdrs,
		     &objp->nfs_argop4_u.opcommit))
			return false;
		lkhd->flags |= NFS_LOOKAHEAD_COMMIT;
		break;
	case NFS4_OP_CREATE:
		if (!xdr_CREATE4args(xdrs,
		     &objp->nfs_argop4_u.opcreate))
			return false;
	...
	case NFS4_OP_GETATTR:
		if (!xdr_GETATTR4args(xdrs,
		     &objp->nfs_argop4_u.opgetattr))
			return false;
		break;
	case NFS4_OP_GETFH:
		break;
	...
	case NFS4_OP_LOCKU:
		...
		break;
	case NFS4_OP_LOOKUP:
		if (!xdr_LOOKUP4args(xdrs,
		     &objp->nfs_argop4_u.oplookup))
			return false;
	...
	case NFS4_OP_REMOVE:
		if (!xdr_REMOVE4args(xdrs,
		     &objp->nfs_argop4_u.opremove))
			return false;
		lkhd->flags |= NFS_LOOKAHEAD_REMOVE;
		break;
	case NFS4_OP_RENAME:
		if (!xdr_RENAME4args(xdrs,
		     &objp->nfs_argop4_u.oprename))
			return false;
	...
	case NFS4_OP_SETCLIENTID_CONFIRM:
		...
		break;
	case NFS4_OP_VERIFY:
		if (!xdr_VERIFY4args(xdrs,
		     &objp->nfs_argop4_u.opverify))
			return false;
		break;
	case NFS4_OP_WRITE:
...
static inline bool xdr_nfs_resop4(XDR *xdrs, nfs_resop4 *objp)
{
	...
	case NFS4_OP_DELEGRETURN:
		...
		break;
	case NFS4_OP_GETATTR:
		if (!xdr_GETATTR4res(xdrs,
		     &objp->nfs_resop4_u.opgetattr))
			return false;
		break;
	case NFS4_OP_GETFH:
	...
	/* NFSv4.2 */
	case NFS4_OP_WRITE_SAME:
		if (!xdr_WRITE_SAME4res(xdrs,
		     &objp->nfs_resop4_u.opwrite_plus))
			return false;
		break;
	case NFS4_OP_READ_PLUS:
		if (!xdr_READ_PLUS4res(xdrs,
		     &objp->nfs_resop4_u.opread_plus))
			return false;
		break;
	case NFS4_OP_SEEK:
		if (!xdr_SEEK4res(xdrs,
		     &objp->nfs_resop4_u.opseek))
			return false;
		break;
	case NFS4_OP_ALLOCATE:
		if (!xdr_ALLOCATE4res(xdrs,
		     &objp->nfs_resop4_u.opallocate))
			return false;
		break;
	case NFS4_OP_DEALLOCATE:
		if (!xdr_DEALLOCATE4res(xdrs,
		     &objp->nfs_resop4_u.opdeallocate))
			return false;
		break;
	case NFS4_OP_IO_ADVISE:
		if (!xdr_IO_ADVISE4res(xdrs,
		     &objp->nfs_resop4_u.opio_advise))
			return false;
		break;
	case NFS4_OP_LAYOUTERROR:

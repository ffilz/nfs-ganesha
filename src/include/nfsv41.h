...
#else				/* K&R C */
#define NFSPROC4_NULL 0
	extern void *nfsproc4_null_4(void);
	extern void *nfsproc4_null_4_svc(void);
#define NFSPROC4_COMPOUND 1
	extern COMPOUND4res *nfsproc4_compound_4(void);
	extern COMPOUND4res *nfsproc4_compound_4_svc(void);
	extern int nfs4_program_4_freeresult(void);
#endif				/* K&R C */
...
#else				/* K&R C */
#define CB_NULL 0
	extern void *cb_null_1(void);
	extern void *cb_null_1_svc(void);
#define CB_COMPOUND 1
	extern CB_COMPOUND4res *cb_compound_1(void);
	extern CB_COMPOUND4res *cb_compound_1_svc(void);
	extern int nfs4_callback_1_freeresult(void);
#endif				/* K&R C */
...
/* Callback operations new to NFSv4.1 */
	...
	static inline bool xdr_nfs_ftype4(void);
	static inline bool xdr_nfsstat4(void);
	static inline bool xdr_attrlist4(void);
	static inline bool xdr_bitmap4(void);
	static inline bool xdr_changeid4(void);
	static inline bool xdr_clientid4(void);
	static inline bool xdr_count4(void);
	static inline bool xdr_length4(void);
	static inline bool xdr_mode4(void);
	static inline bool xdr_nfs_cookie4(void);
	static inline bool xdr_nfs_fh4(void);
	static inline bool xdr_offset4(void);
	static inline bool xdr_qop4(void);
	static inline bool xdr_sec_oid4(void);
	static inline bool xdr_sequenceid4(void);
	static inline bool xdr_seqid4(void);
	static inline bool xdr_sessionid4(void);
	static inline bool xdr_slotid4(void);
	static inline bool xdr_utf8string(void);
	static inline bool xdr_utf8str_cis(void);
	static inline bool xdr_utf8str_cs(void);
	static inline bool xdr_utf8str_mixed(void);
	static inline bool xdr_component4(void);
	static inline bool xdr_linktext4(void);
	static inline bool xdr_pathname4(void);
	static inline bool xdr_verifier4(void);
	static inline bool xdr_nfstime4(void);
	static inline bool xdr_time_how4(void);
	static inline bool xdr_settime4(void);
	static inline bool xdr_nfs_lease4(void);
	static inline bool xdr_fsid4(void);
	static inline bool xdr_change_policy4(void);
	static inline bool xdr_fs_location4(void);
	static inline bool xdr_fs_locations4(void);
	static inline bool xdr_acetype4(void);
	static inline bool xdr_aceflag4(void);
	static inline bool xdr_acemask4(void);
	static inline bool xdr_nfsace4(void);
	static inline bool xdr_aclflag4(void);
	static inline bool xdr_nfsacl41(void);
	static inline bool xdr_mode_masked4(void);
	static inline bool xdr_specdata4(void);
	static inline bool xdr_netaddr4(void);
	static inline bool xdr_nfs_impl_id4(void);
	static inline bool xdr_stateid4(void);
	static inline bool xdr_layouttype4(void);
	static inline bool xdr_layout_content4(void);
	static inline bool xdr_layouthint4(void);
	static inline bool xdr_layoutiomode4(void);
	static inline bool xdr_layout4(void);
	static inline bool xdr_deviceid4(void);
	static inline bool xdr_device_addr4(void);
	static inline bool xdr_layoutupdate4(void);
	static inline bool xdr_layoutreturn_type4(void);
	static inline bool xdr_layoutreturn_file4(void);
	static inline bool xdr_layoutreturn4(void);
	static inline bool xdr_fs4_status_type(void);
	static inline bool xdr_fs4_status(void);
	static inline bool xdr_threshold4_read_size(void);
	static inline bool xdr_threshold4_write_size(void);
	static inline bool xdr_threshold4_read_iosize(void);
	static inline bool xdr_threshold4_write_iosize(void);
	static inline bool xdr_threshold_item4(void);
	static inline bool xdr_mdsthreshold4(void);
	static inline bool xdr_retention_get4(void);
	static inline bool xdr_retention_set4(void);
	static inline bool xdr_fs_charset_cap4(void);
	static inline bool xdr_fattr4_supported_attrs(void);
	static inline bool xdr_fattr4_type(void);
	static inline bool xdr_fattr4_fh_expire_type(void);
	static inline bool xdr_fattr4_change(void);
	static inline bool xdr_fattr4_size(void);
	static inline bool xdr_fattr4_link_support(void);
	static inline bool xdr_fattr4_symlink_support(void);
	static inline bool xdr_fattr4_named_attr(void);
	static inline bool xdr_fattr4_fsid(void);
	static inline bool xdr_fattr4_unique_handles(void);
	static inline bool xdr_fattr4_lease_time(void);
	static inline bool xdr_fattr4_rdattr_error(void);
	static inline bool xdr_fattr4_acl(void);
	static inline bool xdr_fattr4_aclsupport(void);
	static inline bool xdr_fattr4_archive(void);
	static inline bool xdr_fattr4_cansettime(void);
	static inline bool xdr_fattr4_case_insensitive(void);
	static inline bool xdr_fattr4_case_preserving(void);
	static inline bool xdr_fattr4_chown_restricted(void);
	static inline bool xdr_fattr4_fileid(void);
	static inline bool xdr_fattr4_files_avail(void);
	static inline bool xdr_fattr4_filehandle(void);
	static inline bool xdr_fattr4_files_free(void);
	static inline bool xdr_fattr4_files_total(void);
	static inline bool xdr_fattr4_fs_locations(void);
	static inline bool xdr_fattr4_hidden(void);
	static inline bool xdr_fattr4_homogeneous(void);
	static inline bool xdr_fattr4_maxfilesize(void);
	static inline bool xdr_fattr4_maxlink(void);
	static inline bool xdr_fattr4_maxname(void);
	static inline bool xdr_fattr4_maxread(void);
	static inline bool xdr_fattr4_maxwrite(void);
	static inline bool xdr_fattr4_mimetype(void);
	static inline bool xdr_fattr4_mode(void);
	static inline bool xdr_fattr4_mode_set_masked(void);
	static inline bool xdr_fattr4_mounted_on_fileid(void);
	static inline bool xdr_fattr4_no_trunc(void);
	static inline bool xdr_fattr4_numlinks(void);
	static inline bool xdr_fattr4_owner(void);
	static inline bool xdr_fattr4_owner_group(void);
	static inline bool xdr_fattr4_quota_avail_hard(void);
	static inline bool xdr_fattr4_quota_avail_soft(void);
	static inline bool xdr_fattr4_quota_used(void);
	static inline bool xdr_fattr4_rawdev(void);
	static inline bool xdr_fattr4_space_avail(void);
	static inline bool xdr_fattr4_space_free(void);
	static inline bool xdr_fattr4_space_total(void);
	static inline bool xdr_fattr4_space_used(void);
	static inline bool xdr_fattr4_system(void);
	static inline bool xdr_fattr4_time_access(void);
	static inline bool xdr_fattr4_time_access_set(void);
	static inline bool xdr_fattr4_time_backup(void);
	static inline bool xdr_fattr4_time_create(void);
	static inline bool xdr_fattr4_time_delta(void);
	static inline bool xdr_fattr4_time_metadata(void);
	static inline bool xdr_fattr4_time_modify(void);
	static inline bool xdr_fattr4_time_modify_set(void);
	static inline bool xdr_fattr4_suppattr_exclcreat(void);
	static inline bool xdr_fattr4_dir_notif_delay(void);
	static inline bool xdr_fattr4_dirent_notif_delay(void);
	static inline bool xdr_fattr4_fs_layout_types(void);
	static inline bool xdr_fattr4_fs_status(void);
	static inline bool xdr_fattr4_fs_charset_cap(void);
	static inline bool xdr_fattr4_layout_alignment(void);
	static inline bool xdr_fattr4_layout_blksize(void);
	static inline bool xdr_fattr4_layout_hint(void);
	static inline bool xdr_fattr4_layout_types(void);
	static inline bool xdr_fattr4_mdsthreshold(void);
	static inline bool xdr_fattr4_retention_get(void);
	static inline bool xdr_fattr4_retention_set(void);
	static inline bool xdr_fattr4_retentevt_get(void);
	static inline bool xdr_fattr4_retentevt_set(void);
	static inline bool xdr_fattr4_retention_hold(void);
	static inline bool xdr_fattr4_dacl(void);
	static inline bool xdr_fattr4_sacl(void);
	static inline bool xdr_fattr4_change_policy(void);
	static inline bool xdr_fattr4(void);
	static inline bool xdr_change_info4(void);
	static inline bool xdr_clientaddr4(void);
	static inline bool xdr_cb_client4(void);
	static inline bool xdr_nfs_client_id4(void);
	static inline bool xdr_client_owner4(void);
	static inline bool xdr_server_owner4(void);
	static inline bool xdr_state_owner4(void);
	static inline bool xdr_open_owner4(void);
	static inline bool xdr_lock_owner4(void);
	static inline bool xdr_nfs_lock_type4(void);
	static inline bool xdr_ssv_subkey4(void);
	static inline bool xdr_ssv_mic_plain_tkn4(void);
	static inline bool xdr_ssv_mic_tkn4(void);
	static inline bool xdr_ssv_seal_plain_tkn4(void);
	static inline bool xdr_ssv_seal_cipher_tkn4(void);
	static inline bool xdr_fs_locations_server4(void);
	static inline bool xdr_fs_locations_item4(void);
	static inline bool xdr_fs_locations_info4(void);
	static inline bool xdr_fattr4_fs_locations_info(void);
	static inline bool xdr_nfl_util4(void);
	static inline bool xdr_filelayout_hint_care4(void);
	static inline bool xdr_nfsv4_1_file_layouthint4(void);
	static inline bool xdr_multipath_list4(void);
	static inline bool xdr_nfsv4_1_file_layout_ds_addr4(void);
	static inline bool xdr_nfsv4_1_file_layout4(void);
	static inline bool xdr_device_error4(void);
	static inline bool xdr_ff_device_versions4(void);
	static inline bool xdr_ff_device_addr4(void);
	static inline bool xdr_ff_data_server4(void);
	static inline bool xdr_ff_mirror4(void);
	static inline bool xdr_ff_layout4(void);
	static inline bool xdr_ff_ioerr4(void);
	static inline bool xdr_ff_io_latency4(void);
	static inline bool xdr_ff_layoutupdate4(void);
	static inline bool xdr_io_info4(void);
	static inline bool xdr_ff_iostats4(void);
	static inline bool xdr_ff_layoutreturn4(void);
	static inline bool xdr_ff_mirrors_hint(void);
	static inline bool xdr_ff_layouthint4(void);
	static inline bool xdr_ff_cb_recall_any_mask(void);
	static inline bool xdr_ACCESS4args(void);
	static inline bool xdr_ACCESS4resok(void);
	static inline bool xdr_ACCESS4res(void);
	static inline bool xdr_CLOSE4args(void);
	static inline bool xdr_CLOSE4res(void);
	static inline bool xdr_COMMIT4args(void);
	static inline bool xdr_COMMIT4resok(void);
	static inline bool xdr_COMMIT4res(void);
	static inline bool xdr_createtype4(void);
	static inline bool xdr_CREATE4args(void);
	static inline bool xdr_CREATE4resok(void);
	static inline bool xdr_CREATE4res(void);
	static inline bool xdr_DELEGPURGE4args(void);
	static inline bool xdr_DELEGPURGE4res(void);
	static inline bool xdr_DELEGRETURN4args(void);
	static inline bool xdr_DELEGRETURN4res(void);
	static inline bool xdr_GETATTR4args(void);
	static inline bool xdr_GETATTR4resok(void);
	static inline bool xdr_GETATTR4res(void);
	static inline bool xdr_GETFH4resok(void);
	static inline bool xdr_GETFH4res(void);
	static inline bool xdr_LINK4args(void);
	static inline bool xdr_LINK4resok(void);
	static inline bool xdr_LINK4res(void);
	static inline bool xdr_open_to_lock_owner4(void);
	static inline bool xdr_exist_lock_owner4(void);
	static inline bool xdr_locker4(void);
	static inline bool xdr_LOCK4args(void);
	static inline bool xdr_LOCK4denied(void);
	static inline bool xdr_LOCK4resok(void);
	static inline bool xdr_LOCK4res(void);
	static inline bool xdr_LOCKT4args(void);
	static inline bool xdr_LOCKT4res(void);
	static inline bool xdr_LOCKU4args(void);
	static inline bool xdr_LOCKU4res(void);
	static inline bool xdr_LOOKUP4args(void);
	static inline bool xdr_LOOKUP4res(void);
	static inline bool xdr_LOOKUPP4res(void);
	static inline bool xdr_NVERIFY4args(void);
	static inline bool xdr_NVERIFY4res(void);
	static inline bool xdr_createmode4(void);
	static inline bool xdr_creatverfattr(void);
	static inline bool xdr_createhow4(void);
	static inline bool xdr_opentype4(void);
	static inline bool xdr_openflag4(void);
	static inline bool xdr_limit_by4(void);
	static inline bool xdr_nfs_modified_limit4(void);
	static inline bool xdr_nfs_space_limit4(void);
	static inline bool xdr_open_delegation_type4(void);
	static inline bool xdr_open_claim_type4(void);
	static inline bool xdr_open_claim_delegate_cur4(void);
	static inline bool xdr_open_claim4(void);
	static inline bool xdr_OPEN4args(void);
	static inline bool xdr_open_read_delegation4(void);
	static inline bool xdr_open_write_delegation4(void);
	static inline bool xdr_why_no_delegation4(void);
	static inline bool xdr_open_none_delegation4(void);
	static inline bool xdr_open_delegation4(void);
	static inline bool xdr_OPEN4resok(void);
	static inline bool xdr_OPEN4res(void);
	static inline bool xdr_OPENATTR4args(void);
	static inline bool xdr_OPENATTR4res(void);
	static inline bool xdr_OPEN_CONFIRM4args(void);
	static inline bool xdr_OPEN_CONFIRM4resok(void);
	static inline bool xdr_OPEN_CONFIRM4res(void);
	static inline bool xdr_OPEN_DOWNGRADE4args(void);
	static inline bool xdr_OPEN_DOWNGRADE4resok(void);
	static inline bool xdr_OPEN_DOWNGRADE4res(void);
	static inline bool xdr_PUTFH4args(void);
	static inline bool xdr_PUTFH4res(void);
	static inline bool xdr_PUTPUBFH4res(void);
	static inline bool xdr_PUTROOTFH4res(void);
	static inline bool xdr_READ4args(void);
	static inline bool xdr_READ4resok(void);
	static inline bool xdr_READ4res(void);
	static inline bool xdr_READDIR4args(void);
	static inline bool xdr_entry4(void);
	static inline bool xdr_dirlist4(void);
	static inline bool xdr_READDIR4resok(void);
	static inline bool xdr_READDIR4res(void);
	static inline bool xdr_READLINK4resok(void);
	static inline bool xdr_READLINK4res(void);
	static inline bool xdr_REMOVE4args(void);
	static inline bool xdr_REMOVE4resok(void);
	static inline bool xdr_REMOVE4res(void);
	static inline bool xdr_RENAME4args(void);
	static inline bool xdr_RENAME4resok(void);
	static inline bool xdr_RENAME4res(void);
	static inline bool xdr_RENEW4args(void);
	static inline bool xdr_RENEW4res(void);
	static inline bool xdr_RESTOREFH4res(void);
	static inline bool xdr_SAVEFH4res(void);
	static inline bool xdr_SECINFO4args(void);
	static inline bool xdr_rpc_gss_svc_t(void);
	static inline bool xdr_rpcsec_gss_info(void);
	static inline bool xdr_secinfo4(void);
	static inline bool xdr_SECINFO4resok(void);
	static inline bool xdr_SECINFO4res(void);
	static inline bool xdr_SETATTR4args(void);
	static inline bool xdr_SETATTR4res(void);
	static inline bool xdr_SETCLIENTID4args(void);
	static inline bool xdr_SETCLIENTID4resok(void);
	static inline bool xdr_SETCLIENTID4res(void);
	static inline bool xdr_SETCLIENTID_CONFIRM4args(void);
	static inline bool xdr_SETCLIENTID_CONFIRM4res(void);
	static inline bool xdr_VERIFY4args(void);
	static inline bool xdr_VERIFY4res(void);
	static inline bool xdr_stable_how4(void);
	static inline bool xdr_WRITE4args(void);
	static inline bool xdr_WRITE4resok(void);
	static inline bool xdr_WRITE4res(void);
	static inline bool xdr_RELEASE_LOCKOWNER4args(void);
	static inline bool xdr_RELEASE_LOCKOWNER4res(void);
	static inline bool xdr_ILLEGAL4res(void);
	static inline bool xdr_gsshandle4_t(void);
	static inline bool xdr_gss_cb_handles4(void);
	static inline bool xdr_callback_sec_parms4(void);
	static inline bool xdr_BACKCHANNEL_CTL4args(void);
	static inline bool xdr_BACKCHANNEL_CTL4res(void);
	static inline bool xdr_channel_dir_from_client4(void);
	static inline bool xdr_BIND_CONN_TO_SESSION4args(void);
	static inline bool xdr_channel_dir_from_server4(void);
	static inline bool xdr_BIND_CONN_TO_SESSION4resok(void);
	static inline bool xdr_BIND_CONN_TO_SESSION4res(void);
	static inline bool xdr_state_protect_ops4(void);
	static inline bool xdr_ssv_sp_parms4(void);
	static inline bool xdr_state_protect_how4(void);
	static inline bool xdr_state_protect4_a(void);
	static inline bool xdr_EXCHANGE_ID4args(void);
	static inline bool xdr_ssv_prot_info4(void);
	static inline bool xdr_state_protect4_r(void);
	static inline bool xdr_EXCHANGE_ID4resok(void);
	static inline bool xdr_EXCHANGE_ID4res(void);
	static inline bool xdr_channel_attrs4(void);
	static inline bool xdr_CREATE_SESSION4args(void);
	static inline bool xdr_CREATE_SESSION4resok(void);
	static inline bool xdr_CREATE_SESSION4res(void);
	static inline bool xdr_DESTROY_SESSION4args(void);
	static inline bool xdr_DESTROY_SESSION4res(void);
	static inline bool xdr_FREE_STATEID4args(void);
	static inline bool xdr_FREE_STATEID4res(void);
	static inline bool xdr_attr_notice4(void);
	static inline bool xdr_GET_DIR_DELEGATION4args(void);
	static inline bool xdr_GET_DIR_DELEGATION4resok(void);
	static inline bool xdr_gddrnf4_status(void);
	static inline bool xdr_GET_DIR_DELEGATION4res_non_fatal(void);
	static inline bool xdr_GET_DIR_DELEGATION4res(void);
	static inline bool xdr_GETDEVICEINFO4args(void);
	static inline bool xdr_GETDEVICEINFO4resok(void);
	static inline bool xdr_GETDEVICEINFO4res(void);
	static inline bool xdr_GETDEVICELIST4args(void);
	static inline bool xdr_GETDEVICELIST4resok(void);
	static inline bool xdr_GETDEVICELIST4res(void);
	static inline bool xdr_newtime4(void);
	static inline bool xdr_newoffset4(void);
	static inline bool xdr_LAYOUTCOMMIT4args(void);
	static inline bool xdr_newsize4(void);
	static inline bool xdr_LAYOUTCOMMIT4resok(void);
	static inline bool xdr_LAYOUTCOMMIT4res(void);
	static inline bool xdr_LAYOUTGET4args(void);
	static inline bool xdr_LAYOUTGET4resok(void);
	static inline bool xdr_LAYOUTGET4res(void);
	static inline bool xdr_LAYOUTRETURN4args(void);
	static inline bool xdr_layoutreturn_stateid(void);
	static inline bool xdr_LAYOUTRETURN4res(void);
	static inline bool xdr_secinfo_style4(void);
	static inline bool xdr_SECINFO_NO_NAME4args(void);
	static inline bool xdr_SECINFO_NO_NAME4res(void);
	static inline bool xdr_SEQUENCE4args(void);
	static inline bool xdr_SEQUENCE4resok(void);
	static inline bool xdr_SEQUENCE4res(void);
	static inline bool xdr_ssa_digest_input4(void);
	static inline bool xdr_SET_SSV4args(void);
	static inline bool xdr_ssr_digest_input4(void);
	static inline bool xdr_SET_SSV4resok(void);
	static inline bool xdr_SET_SSV4res(void);
	static inline bool xdr_TEST_STATEID4args(void);
	static inline bool xdr_TEST_STATEID4resok(void);
	static inline bool xdr_TEST_STATEID4res(void);
	static inline bool xdr_deleg_claim4(void);
	static inline bool xdr_WANT_DELEGATION4args(void);
	static inline bool xdr_WANT_DELEGATION4res(void);
	static inline bool xdr_DESTROY_CLIENTID4args(void);
	static inline bool xdr_DESTROY_CLIENTID4res(void);
	static inline bool xdr_RECLAIM_COMPLETE4args(void);
	static inline bool xdr_RECLAIM_COMPLETE4res(void);
	static inline bool xdr_nfs_opnum4(void);
	static inline bool xdr_nfs_argop4(void);
	static inline bool xdr_nfs_resop4(void);
	static inline bool xdr_COMPOUND4args(void);
	static inline bool xdr_COMPOUND4res(void);
	static inline bool xdr_CB_GETATTR4args(void);
	static inline bool xdr_CB_GETATTR4resok(void);
	static inline bool xdr_CB_GETATTR4res(void);
	static inline bool xdr_CB_RECALL4args(void);
	static inline bool xdr_CB_RECALL4res(void);
	static inline bool xdr_CB_ILLEGAL4res(void);
	static inline bool xdr_layoutrecall_type4(void);
	static inline bool xdr_layoutrecall_file4(void);
	static inline bool xdr_layoutrecall4(void);
	static inline bool xdr_CB_LAYOUTRECALL4args(void);
	static inline bool xdr_CB_LAYOUTRECALL4res(void);
	static inline bool xdr_notify_type4(void);
	static inline bool xdr_notify_entry4(void);
	static inline bool xdr_prev_entry4(void);
	static inline bool xdr_notify_remove4(void);
	static inline bool xdr_notify_add4(void);
	static inline bool xdr_notify_attr4(void);
	static inline bool xdr_notify_rename4(void);
	static inline bool xdr_notify_verifier4(void);
	static inline bool xdr_notifylist4(void);
	static inline bool xdr_notify4(void);
	static inline bool xdr_CB_NOTIFY4args(void);
	static inline bool xdr_CB_NOTIFY4res(void);
	static inline bool xdr_CB_PUSH_DELEG4args(void);
	static inline bool xdr_CB_PUSH_DELEG4res(void);
	static inline bool xdr_CB_RECALL_ANY4args(void);
	static inline bool xdr_CB_RECALL_ANY4res(void);
	static inline bool xdr_CB_RECALLABLE_OBJ_AVAIL4args(void);
	static inline bool xdr_CB_RECALLABLE_OBJ_AVAIL4res(void);
	static inline bool xdr_CB_RECALL_SLOT4args(void);
	static inline bool xdr_CB_RECALL_SLOT4res(void);
	static inline bool xdr_referring_call4(void);
	static inline bool xdr_referring_call_list4(void);
	static inline bool xdr_CB_SEQUENCE4args(void);
	static inline bool xdr_CB_SEQUENCE4resok(void);
	static inline bool xdr_CB_SEQUENCE4res(void);
	static inline bool xdr_CB_WANTS_CANCELLED4args(void);
	static inline bool xdr_CB_WANTS_CANCELLED4res(void);
	static inline bool xdr_CB_NOTIFY_LOCK4args(void);
	static inline bool xdr_CB_NOTIFY_LOCK4res(void);
	static inline bool xdr_notify_deviceid_type4(void);
	static inline bool xdr_notify_deviceid_delete4(void);
	static inline bool xdr_notify_deviceid_change4(void);
	static inline bool xdr_CB_NOTIFY_DEVICEID4args(void);
	static inline bool xdr_CB_NOTIFY_DEVICEID4res(void);
	static inline bool xdr_nfs_cb_opnum4(void);
	static inline bool xdr_nfs_cb_argop4(void);
	static inline bool xdr_nfs_cb_resop4(void);
	static inline bool xdr_CB_COMPOUND4args(void);
	static inline bool xdr_CB_COMPOUND4res(void);

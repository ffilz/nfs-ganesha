...
static inline
bool PTHREAD_MUTEX_decrement_int64_t_and_lock(int64_t *var,
...
#if defined(GCC_ATOMIC_FUNCTIONS) | defined(GCC_SYNC_FUNCTIONS)
static inline
bool PTHREAD_MUTEX_decrement_uint64_t_and_lock(uint64_t *var,
					       pthread_mutex_t *lock)
{
...
#if defined(GCC_ATOMIC_FUNCTIONS) | defined(GCC_SYNC_FUNCTIONS)
static inline
bool PTHREAD_MUTEX_decrement_int32_t_and_lock(int32_t *var,
					      pthread_mutex_t *lock)
{
...
#if defined(GCC_ATOMIC_FUNCTIONS) | defined(GCC_SYNC_FUNCTIONS)
static inline
bool PTHREAD_MUTEX_decrement_uint32_t_and_lock(uint32_t *var,
					       pthread_mutex_t *lock)
{

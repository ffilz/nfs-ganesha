 ...
 */
static void get_op_ctx_creds(struct _9p_fid *pfid)
{
...
/**
 * @brief Release a reference obtained with get_op_ctx_creds.
 *
 ...
 */
static void release_op_ctx_creds(void)
{

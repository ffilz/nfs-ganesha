...
bool pseudo_mount_export(struct gsh_export *export)
{
	...
	*last_slash = '/';
	 ...
	 * Note that this is the last thing that should be updated on this handle,
	 * since setting the junction_export is what signals to the PSEUDO FSAL
	 * that this entry is done.
	 */

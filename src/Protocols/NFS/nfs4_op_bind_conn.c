		      ...
		      struct nfs_resop4 *resp)
{
	...
	BIND_CONN_TO_SESSION4resok * const resok_BIND_CONN_TO_SESSION4 =
				&res_BIND_CONN_TO_SESSION4->
					BIND_CONN_TO_SESSION4res_u.bctsr_resok4;
	...
	/* OP_BIND_CONN_TO_SESSION is always the first operation of the request
	 */
	if (data->oppos != 0) {
		res_BIND_CONN_TO_SESSION4->bctsr_status = NFS4ERR_SEQUENCE_POS;
		return res_BIND_CONN_TO_SESSION4->bctsr_status;
	}

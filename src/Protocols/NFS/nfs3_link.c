...
/** @fn static enum nfsstat3
 *	nfs3_verify_exportid(struct LINK3args *link3, struct svc_req *req)
 *
...
nfs3_verify_exportid(struct LINK3args *link3, struct svc_req *req)
{
	const short to_exportid = nfs3_FhandleToExportId(&link3->link.dir);
	const short from_exportid = nfs3_FhandleToExportId(&link3->file);

				     ...
				     struct nfs_resop4 *resp)
{
	...
	GSH_AUTO_TRACEPOINT(nfs4, op_sequence_start, TRACE_INFO,
			    "SEQUENCE arg: session={} sequence={} slotid={} "
			    "highest_slotid={} cachethis={}",
			    TP_SESSION(arg_SEQUENCE4->sa_sessionid),
			    arg_SEQUENCE4->sa_sequenceid,
			    arg_SEQUENCE4->sa_slotid,
			    arg_SEQUENCE4->sa_highest_slotid,
	...
	GSH_AUTO_TRACEPOINT(
		...
		"SEQUENCE res: status={} session={} sequence={} slotid={} "
		"status_flags={}",

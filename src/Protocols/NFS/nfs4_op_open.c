				 ...
				 struct nfs_resop4 *resp)
{
	 ...
	 * are optional hints that servers MAY ignore. We accept them to maintain
	 * compatibility with clients that send them, and silently ignore them
	 * during delegation processing.
	 *

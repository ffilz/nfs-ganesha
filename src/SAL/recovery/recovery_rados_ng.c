 ...
 * the old keys. We then will spool up new client creation to that transaction
 * during the grace period.
 *
 * When we go to lift the grace period, synchronously send the transaction
 * to the kvstore. After this, all client creation and removal is done

...
check_it:
	 ...
	 *
	 * This list-based check ensures that if the stateid was recorded
	 * in revoked_delegations_list at revoke time 
	 * (via add_to_revoked_delegations()), we detect it here and 

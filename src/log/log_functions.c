...
static struct config_item logging_params[] = {
	...
	CONF_OPTIONAL_BLOCK("Facility", facility_params,
			    facility_init, facility_commit,
			    logger_config, facility_list),
	CONF_OPTIONAL_BLOCK("Format", format_options,
			    format_init, format_commit,
			    logger_config, logfields),
	CONF_OPTIONAL_BLOCK("Components", component_levels,
...
struct config_block logging_param = {
	...
	/* too risky to have more and params are optional */
	.blk_desc.flags = CONFIG_UNIQUE | CONFIG_OPTIONAL,

		   ...
		   const struct fridgethr_params *p)
{
	...
	frobj = gsh_malloc(sizeof(struct fridgethr), MEM_COMP_INIT);
			   ...
			   void (*func)(struct fridgethr_context *), void *arg)
{
	...
	fe = gsh_calloc(1, sizeof(struct fridgethr_entry), MEM_COMP_INIT);
			   ...
			   void (*func)(struct fridgethr_context *), void *arg)
{
	...
	q = gsh_malloc(sizeof(struct fridgethr_work), MEM_COMP_INIT);

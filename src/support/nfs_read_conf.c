...
static struct config_item core_params[] = {
	...
	CONF_ITEM_BOOL("mount_path_pseudo", false, nfs_core_param,
		       mount_path_pseudo),
	CONF_ITEM_BOOL("enable_qos", false, nfs_core_param,
		       qos_global_config.enable_qos),
	CONF_ITEM_BOOL("enable_tokens", false, nfs_core_param,
		       qos_global_config.enable_tokens),
	CONF_ITEM_BOOL("enable_bw_control", false, nfs_core_param,
		       qos_global_config.enable_bw_control),
	CONF_ITEM_BOOL("combined_rw_bw_control", false, nfs_core_param,
		       qos_global_config.combined_rw_bw_control),
	CONF_ITEM_BOOL("combined_rw_token_control", true, nfs_core_param,
		       qos_global_config.combined_rw_token_control),
	CONF_ITEM_UI64("max_export_write_bw", 0, UINT64_MAX,
		       86400, nfs_core_param,
		       qos_global_config.max_export_write_bw),
	CONF_ITEM_UI64("max_export_read_bw", 0, UINT64_MAX,
		       86400, nfs_core_param,
		       qos_global_config.max_export_read_bw),
	CONF_ITEM_UI64("max_client_write_bw", 0, UINT64_MAX,
		       86400, nfs_core_param,
		       qos_global_config.max_client_write_bw),
	CONF_ITEM_UI64("max_client_read_bw", 0, UINT64_MAX,
		       86400, nfs_core_param,
		       qos_global_config.max_client_read_bw),
	CONF_ITEM_UI64("max_export_write_tokens", 0, UINT64_MAX,
		       86400, nfs_core_param,
		       qos_global_config.max_export_write_tokens),
	CONF_ITEM_UI64("max_export_read_tokens", 0, UINT64_MAX,
		       86400, nfs_core_param,
		       qos_global_config.max_export_read_tokens),
	CONF_ITEM_UI64("max_client_write_tokens", 0, UINT64_MAX,
		       86400, nfs_core_param,
		       qos_global_config.max_client_write_tokens),
	CONF_ITEM_UI64("max_client_read_tokens", 0, UINT64_MAX,
		       86400, nfs_core_param,
		       qos_global_config.max_client_read_tokens),
	CONF_ITEM_UI64("export_write_tokens_renew_time", 0, UINT64_MAX,
		       86400, nfs_core_param,
		       qos_global_config.export_write_tokens_renew_time),
	CONF_ITEM_UI64("export_read_tokens_renew_time", 0, UINT64_MAX,
		       86400, nfs_core_param,
		       qos_global_config.export_read_tokens_renew_time),
	CONF_ITEM_UI64("client_write_tokens_renew_time", 0, UINT64_MAX,
		       86400, nfs_core_param,
		       qos_global_config.client_write_tokens_renew_time),
	CONF_ITEM_UI64("client_read_tokens_renew_time", 0, UINT64_MAX,
		       86400, nfs_core_param,
		       qos_global_config.client_read_tokens_renew_time),
	...
	CONF_ITEM_UI32("Max_Uid_To_Group_Reqs", 0, INT32_MAX, 0, nfs_core_param,
		       max_uid_to_grp_reqs),
	CONF_ITEM_UI32("qos_type", 0, INT32_MAX, 0, nfs_core_param,
		       qos_global_config.qos_type),

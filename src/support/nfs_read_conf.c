...
static struct config_item_list Policys[] = {
...
static struct config_item core_params[] = {
	...
	CONF_ITEM_CPUS_ALLOWED("Worker_Cpus_Allowed", nfs_core_param,
			       worker_mask),
	CONF_ITEM_ENUM("Worker_Policy", CPUS_SHARED, Policys, nfs_core_param,
		       worker_policy),
	...
	CONF_ITEM_CPUS_ALLOWED("Decoder_Cpus_Allowed", nfs_core_param,
			       decoder_mask),
	CONF_ITEM_ENUM("Decoder_Policy", CPUS_SHARED, Policys, nfs_core_param,
		       decoder_policy),

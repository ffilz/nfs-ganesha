...
static struct config_item_list Svc_Cpus_Allowed_Policys[] = {
...
static struct config_item core_params[] = {
	...
	CONF_ITEM_CPU_MASK("Worker_Cpumask", nfs_core_param, worker_mask),
	CONF_ITEM_CPUS_ALLOWED("Worker_Cpus_Allowed", nfs_core_param,
			       worker_mask),
	CONF_ITEM_ENUM("Worker_Cpus_Allowed_Policy", CPUS_SHARED,
		       Cpus_Allowed_Policys, nfs_core_param, worker_policy),
	...
	CONF_ITEM_CPU_MASK("Sender_Cpumask", nfs_core_param, rpc.sender_mask),
	CONF_ITEM_CPUS_ALLOWED("Sender_Cpus_Allowed", nfs_core_param,
			       rpc.sender_mask),
	CONF_ITEM_ENUM("Sender_Cpus_Allowed_Policy", CPUS_SHARED,
		       Svc_Cpus_Allowed_Policys, nfs_core_param,
		       rpc.sender_policy),
	...
	CONF_ITEM_CPU_MASK("Decoder_Cpumask", nfs_core_param, decoder_mask),

...
static struct config_item version4_params[] = {
	...
	/* Default of Expired_Client_Threshold is set to be 16,
	 * Unit and Functional Test suites may be required to be changed
	 */
	CONF_ITEM_UI32("Expired_Client_Threshold", 0, UINT32_MAX, 16,
		       nfs_version4_parameter, expired_client_threshold),
	CONF_ITEM_UI32("Max_Open_Files_For_Expired_Client", 0, UINT32_MAX, 100,

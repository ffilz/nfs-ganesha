				...
				const char *function)
{
	...
	LogFullDebug(COMPONENT_MEM_ALLOC,
		     "Component: %s, L_ac/L_fc/L_ab/L_fb: %" PRIu64 " %" PRIu64
		     " %" PRIu64 " %" PRIu64 " I_ac/I_fc/I_ab/I_fb: %" PRIu64
		     " %" PRIu64 " %" PRIu64 " %" PRIu64 " current: %" PRIu64

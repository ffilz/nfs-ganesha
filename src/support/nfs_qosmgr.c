...
#define MAX_IOPS_IN { "max_iops", "u", "in" }
#define MAX_IOPS_OUT { "max_iops", "u", "out" }
 ...
 *
 * This function retrieves the current IOPS limits for clients under a pepc configuration.
 *
 * @param [in] args DBusMessageIter containing the input arguments
 * @param [in] reply DBusMessage to store the output result
 * @param [in] error DBusError object to handle any errors that occur
...
static struct gsh_dbus_method qos_export_enable_all_clients_iops_control_pepc = {
	.name = "EnableAllClientQosIopsControlpepc",
	.method = dbus_qos_enable_iops_control_pepc,
	.args = { EXPORT_ID_ARG, SUCCESS_ARG, END_ARG_LIST }
};

static struct gsh_dbus_method qos_export_disable_all_clients_iops_control_pepc = {
...
static struct gsh_dbus_method *qos_methods_pepc[] = {
	...
	&qos_export_enable_all_clients_iops_control_pepc,
	&qos_export_disable_all_clients_iops_control_pepc,

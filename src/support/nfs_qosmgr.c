...
/**
 * @brief Get bandwidth settings for clients in a PSPC configuration.
 * This function retrieves the current bandwidth limits for clients
 * under a PSPC configuration.
 *
 * @param [in] args DBusMessageIter containing the input arguments
 * @param [in] reply DBusMessage to store the output result
 * @param [in] error DBusError object to handle any errors that occur
...
/**
 * @brief Get bandwidth settings for a share.
 *
 * This function retrieves the current bandwidth limits for a given share.
 *
 * @param [in] args DBusMessageIter containing the input arguments
 * @param [in] reply DBusMessage to store the output result
 * @param [in] error DBusError object to handle any errors that occur
...
/**
 * @brief Get token settings for a share.
 *
 * This function retrieves the current token limits for a given share.
 *
 * @param [in] args DBusMessageIter containing the input arguments
 * @param [in] reply DBusMessage to store the output result
 * @param [in] error DBusError object to handle any errors that occur
...
/**
 * @brief Get default client bandwidth settings for a share.
...
/**
 * @brief Set bandwidth settings for a share.
 *
 * This function sets the bandwidth limits for a specified share.
 *
 * @param [in] args DBusMessageIter containing the input arguments
 * @param [in] reply DBusMessage to store the output result
 * @param [in] error DBusError object to handle any errors that occur
...
/**
 * @brief Set token settings for a share.
 *
 * This function sets the token limits for a specified share.
 *
 * @param [in] args DBusMessageIter containing the input arguments
 * @param [in] reply DBusMessage to store the output result
 * @param [in] error DBusError object to handle any errors that occur
...
/**
 * @brief Set bandwidth settings for a client in a PSPC configuration.
 *
 * @param [in] args DBusMessageIter containing the input arguments
 * @param [in] reply DBusMessage to store the output result
 * @param [in] error DBusError object to handle any errors that occur
...
/**
 * @brief Set default client bandwidth settings for a share.
 *
 * This function sets the default client bandwidth limits for a specified share.
 *
 * @param [in] args DBusMessageIter containing the input arguments
 * @param [in] reply DBusMessage to store the output result
 * @param [in] error DBusError object to handle any errors that occur
...
/**
 * @brief Enable bandwidth control for a share.
 *
 * This function enables bandwidth control for a specified share.
 *
 * @param [in] args DBusMessageIter containing the input arguments
 * @param [in] reply DBusMessage to store the output result
 * @param [in] error DBusError object to handle any errors that occur
...
/**
 * @brief Disable bandwidth control for a share under a PSPC configuration.
 *
 * @param [in] args DBusMessageIter containing the input arguments
 * @param [in] reply DBusMessage to store the output result
 * @param [in] error DBusError object to handle any errors that occur
...
/**
 * @brief Enable bandwidth control for a share under a PSPC configuration.
 *
 * @param [in] args DBusMessageIter containing the input arguments
 * @param [in] reply DBusMessage to store the output result
 * @param [in] error DBusError object to handle any errors that occur

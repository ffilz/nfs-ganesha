...
void init_custom_data_for_xprt(SVCXPRT *xprt)
{
	...
	xprt_custom_data_t * const xprt_data =
		gsh_malloc(sizeof(xprt_custom_data_t));
...
bool add_nfs41_session_to_xprt(SVCXPRT *xprt, nfs41_session_t *session)
{
	...
	nfs41_session_list_entry_t * const new_entry =
		gsh_malloc(sizeof(nfs41_session_list_entry_t));
	...
	nfs41_session_t *session)
{
	...
	xprt_custom_data_t * const xprt_data =
		(xprt_custom_data_t *) xprt->xp_u1;
	nfs41_sessions_holder_t * const sessions_holder =
		&xprt_data->nfs41_sessions_holder;

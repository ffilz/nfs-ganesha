...
uint64_t hash_sockaddr(sockaddr_t *addr, bool ignore_port)
{
	...
	case AF_INET: {
		/* IPv6 spec allows IPv4 addresses to be mapped as IPv6
		 * addresses. This allows us to ensure that an IPv4 address
		 * has the same hash whether mapped as IPv6 or not.
		 */

 ...
 * PROXY protocol client and the export client entry applies to PROXY protocol
 * clients or the current client is not a PROXY protocol client and the client
 * entry applies to non-PROXY protocol clients.
 */

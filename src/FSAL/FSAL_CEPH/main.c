...
static void enable_delegations(struct ceph_mount *cm)
{
	 ...
	 * We just need to check if delegation option has been set
	 * in any of these stanzas. We do not need to check which EXPORT
	 * or CLIENT specifically has set the delegation.
	 */

...
has_cmount:
	...
	/* If the cmount has no exports, then do not enable delegations */
	if (glist_empty(&cm->cm_exports)) {
		LogFullDebug(COMPONENT_FSAL,
				"Export list for the cmount is empty");
	} else {
		LogFullDebug(COMPONENT_FSAL,
				"Refcount of exports sharing this cmount %d",
				cm->cm_refcnt);

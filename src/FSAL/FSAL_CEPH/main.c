...
static bool ceph_register_nfs_service(void)
{
	void *dl = NULL;
	...
	bool (*register_nfs_fun_ptr)(char *);

	register_nfs_fun_ptr = dlsym(dl, "register_service");
	return register_nfs_fun_ptr(CephFSM.nodeid);
}

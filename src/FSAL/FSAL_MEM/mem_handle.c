				  ...
				  struct fsal_attrlist *outattrs)
{
	...
	GSH_AUTO_TRACEPOINT(fsalmem, mem_getattrs, TRACE_DEBUG,
		"Get attrs. Handle: {}, name: {}, "
		"filesize: {}, numlinks: {}, change: {}",
			   ...
			   struct fsal_attrlist *attrs_set)
{
	...
	GSH_AUTO_TRACEPOINT(fsalmem, mem_setattrs, TRACE_DEBUG,
		"Set attrs. Handle: {}, name: {}, size: {}, numlinks: {}, "
		"change: {}", obj_hdl, TP_STR(myself->m_name),
		myself->attrs.filesize, myself->attrs.numlinks,
		myself->attrs.change);
		       ...
		       struct fsal_attrlist *destdir_post_attrs_out)
{
	...
	GSH_AUTO_TRACEPOINT(fsalmem, mem_link, TRACE_DEBUG,
		"Link. Dir handle: {}, dir name: {}, obj handle: {}, "
		"obj name: {}, new name {}, num links: {}", dir_hdl,
		TP_STR(dir->m_name), obj_hdl, TP_STR(myself->m_name),
				...
				struct fsal_attrlist *parent_post_attrs_out)
{
	...
	GSH_AUTO_TRACEPOINT(fsalmem, mem_unlink, TRACE_DEBUG,
		"Unlink. Dir handle: {}, dir name: {}, obj handle: {}, "
		"obj name: {}, num links: {}", dir_hdl, TP_STR(parent->m_name),
				...
				struct fsal_attrlist *newdir_post_attrs_out)
{
	...
	GSH_AUTO_TRACEPOINT(fsalmem, mem_rename, TRACE_DEBUG,
		"Rename. Handle: {}, old dir name: {}, old name: {}, "
		"new dir name: {}, new name: {}", obj_hdl,
		TP_STR(mem_olddir->m_name), TP_STR(old_name),
			...
			struct fsal_attrlist *parent_post_attrs_out)
{
	...
	if (name == NULL) {
		...
		GSH_AUTO_TRACEPOINT(fsalmem, mem_open_by_handle, TRACE_DEBUG,
			"Open by handle. Handle: {}, name: {}, state: {}, "
			"truncated: {}, setattrs: {}", obj_hdl,
			TP_STR(myself->m_name), state, truncated, setattrs);
	...
	GSH_AUTO_TRACEPOINT(fsalmem, mem_open, TRACE_DEBUG,
		"Open . Handle: {}, name: {}, state: {}, "
		"truncated: {}, setattrs: {}", &hdl->obj_handle,
		TP_STR(hdl->m_name), state, truncated, setattrs);
	       ...
	       void *caller_arg)
{
	...
	GSH_AUTO_TRACEPOINT(fsalmem, mem_read, TRACE_DEBUG,
		"Read. Handle: {}, name: {}, state: {}, size: {}, "
		"spaceused: {}", obj_hdl, TP_STR(myself->m_name),

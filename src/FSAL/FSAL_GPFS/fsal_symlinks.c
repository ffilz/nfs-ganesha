 ...
 * @param link_name Name of the link to be created.
 * @param link_content Content of the link to be created.
 * @param op_ctx Authentication context for the operation (user,...).
 * @param accessmode Mode of the link to be created.
 *		     It has no sense in HPSS nor UNIX filesystems.
 * @param link_handle Pointer to the handle of the created symlink.

	     ...
	     struct fsal_export *exp_hdl)
{
	...
	struct gpfs_fsal_obj_handle *hdl =
		gsh_calloc(sizeof(struct gpfs_fsal_obj_handle) +
			   sizeof(struct gpfs_file_handle), 1);
...
/** @fn static fsal_status_t
 *	readsymlink(struct fsal_obj_handle *obj_hdl,
...
/** @fn static fsal_status_t
 *	linkfile(struct fsal_obj_handle *obj_hdl,
...
/** @fn static fsal_status_t
 *	getxattrs(struct fsal_obj_handle *obj_hdl, xattrname4 *xa_name,
 *		  xattrvalue4 *xa_value)
 *
 *  @param obj_hdl Handle
 *  @param xa_name attribute name
 *  @param xa_value attribute value
 *
 *  @return Status of operation
 */
static fsal_status_t
...
/** @fn static fsal_status_t
 *	setxattrs(struct fsal_obj_handle *obj_hdl, setxattr_type4 sa_type,
 *		  xattrname4 *xa_name, xattrvalue4 *xa_value)
 *
 *  @param obj_hdl Handle
 *  @param sa_type attribute type
 *  @param xa_name attribute name
 *  @param xa_value attribute value
 *
 *  @return Status of operation
	  ...
	  xattrname4 *xa_name, xattrvalue4 *xa_value)
{
	...
	errsv = errno;
	LogDebug(COMPONENT_FSAL,
		"SETXATTRS returned rc %d errsv %d", rc, errsv);
...
/** @fn static fsal_status_t
 *	removexattrs(struct fsal_obj_handle *obj_hdl, xattrname4 *xa_name)
 *
 *  @param obj_hdl Handle
 *  @param xa_name attribute name
 *
...
removexattrs(struct fsal_obj_handle *obj_hdl, xattrname4 *xa_name)
{
	int rc;
	int errsv = 0;
	struct removexattr_arg rxarg = {0};
	struct gpfs_filesystem *gpfs_fs = obj_hdl->fs->private;
	struct gpfs_fsal_obj_handle *myself =
		container_of(obj_hdl, struct gpfs_fsal_obj_handle, obj_handle);
 ...
 *		   nfs_cookie4 *la_cookie, verifier4 *la_cookieverf,
...
static fsal_status_t
listxattrs(struct fsal_obj_handle *obj_hdl, count4 la_maxcount,
	   nfs_cookie4 *la_cookie, verifier4 *la_cookieverf, bool_t *lr_eof,
	   xattrlist4 *lr_names)
{
	int rc;
	int errsv;
		   ...
		   struct fsal_obj_handle **handle)
{
	...
	*handle = NULL;		/* poison it first */
	...
	memcpy(gpfs_fh, hdl_desc->addr, hdl_desc->len); /* aligned copy */

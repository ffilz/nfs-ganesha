...
static struct config_item mdcache_params[] = {
	...
	CONF_ITEM_UI32("Dir_Chunk", 0, UINT32_MAX, 128,
		       mdcache_parameter, dir.avl_loose_mult),
	CONF_ITEM_UI32("Loose_Mult", 1, UINT32_MAX, 1,
				...
				struct config_error_type *err_type)
{
	...
	/* Compute avl_loose_max from avl_chunk and avl_loose_mult */
	mdcache_param.dir.avl_loose_max = mdcache_param.dir.avl_chunk *
					  mdcache_param.dir.avl_loose_mult;

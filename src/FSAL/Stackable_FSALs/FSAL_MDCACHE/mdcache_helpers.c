...
#ifdef USE_LTTNG
	tracepoint(mdcache, mdc_readdir_populate, __func__, __LINE__,
...
#ifdef USE_LTTNG
	tracepoint(mdcache, mdc_readdir, __func__, __LINE__,
...
#ifdef USE_LTTNG
		tracepoint(mdcache, mdc_readdir_cb, __func__, __LINE__,
			   dirent->name, &entry->obj_handle, entry->sub_handle,
			   entry->lru.refcnt);
#endif
...
#ifdef USE_LTTNG
	tracepoint(mdcache, mdc_kill_entry, function, line, &entry->obj_handle,

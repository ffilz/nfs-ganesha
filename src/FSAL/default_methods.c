...
static fsal_status_t reopen_fd(struct fsal_obj_handle *obj_hdl,
...
static fsal_status_t read_fd(struct fsal_obj_handle *obj_hdl,
			     struct fsal_fd *share_fd,
...
static fsal_status_t read_plus_fd(struct fsal_obj_handle *obj_hdl,
				  struct fsal_fd *share_fd,
				  struct fsal_fd *lock_fd,
				  uint64_t seek_descriptor,
				  size_t buffer_size,
...
static fsal_status_t write_fd(struct fsal_obj_handle *obj_hdl,
			      struct fsal_fd *share_fd,
			      struct fsal_fd *lock_fd,
			      uint64_t seek_descriptor,
			      size_t buffer_size,
...
static fsal_status_t write_plus_fd(struct fsal_obj_handle *obj_hdl,
				   struct fsal_fd *share_fd,
				   struct fsal_fd *lock_fd,
				   uint64_t seek_descriptor,
				   size_t buffer_size,
...
static fsal_status_t lock_op_fd(struct fsal_obj_handle *obj_hdl,
				struct fsal_fd *share_fd,
				struct fsal_fd *lock_fd,
				void *p_owner,
				fsal_lock_op_t lock_op,
...
static fsal_status_t setattr_fd(struct fsal_obj_handle *obj_hdl,
				struct fsal_fd *share_fd,
				struct fsal_fd *lock_fd,
				struct attrlist *attrs)
{

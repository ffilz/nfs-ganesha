...
namespace {
  ...
  protected:
    ...
    virtual void SetUp() {
      ...
      status = test_root->obj_ops.open2(test_root, &test_file_state, FSAL_O_RDWR, FSAL_UNCHECKED,
		      TEST_FILE, NULL, NULL, &test_file, NULL, &caller_perm_check);
      ASSERT_EQ(status.major, 0);

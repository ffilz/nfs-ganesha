...
The EXPORT blocks define the file name spaces that are served by NFS-Ganesha.
...
subvolumes. Starting in NFS-Ganesha V4.0 SAL_VFS treats these as separate
filesystems and are integrated with all the richness of FSAL_VFS exports.

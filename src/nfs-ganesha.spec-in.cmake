...
%endif
Requires:	nfs-utils
%if ( 0%{?fedora} ) || ( 0%{?rhel} && 0%{?rhel} >= 6 ) || ( 0%{?suse_version} > 1210 )
Requires:	rpcbind
%else
Requires:	portmap
%endif
...
cat > scripts/systemd/nfs-ganesha-config.service << '__SCRIPT_END__'
# This file is part of nfs-ganesha and is dynamically created during install.
#
...
[Service]
Type=oneshot
ExecStart=%{_libexecdir}/ganesha/nfs-ganesha-config.sh
__SCRIPT_END__

...
int main(int argc, char *argv[])
{
	...
	monitoring_worker_thread_max_increment(nfs_param.core_param.rpc.ioq_thrd_max);
	monitoring_worker_thread_min_increment(nfs_param.core_param.rpc.ioq_thrd_min);
#endif  /* USE_MONITORING */

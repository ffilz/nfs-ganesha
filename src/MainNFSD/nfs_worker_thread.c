...
void free_args(nfs_request_t *reqdata)
{
	...
	GSH_AUTO_TRACEPOINT(nfs_rpc, end, TRACE_DEBUG,
				     ...
				     enum nfs_req_result rc)
{
	...
	GSH_XPRT_AUTO_TRACEPOINT(nfs_rpc, before_reply, TRACE_DEBUG, xprt,
		"Before reply");
...
{
	GSH_AUTO_TRACEPOINT(nfs_rpc, op_end, TRACE_DEBUG,
				   ...
				   const char *client_ip)
{
	...
	GSH_XPRT_UNIQUE_AUTO_TRACEPOINT(nfs_rpc, before_reply, TRACE_DEBUG,
					      ...
					      bool retry)
{
	...
	GSH_AUTO_TRACEPOINT(nfs_rpc, start, TRACE_DEBUG,
...
retry_after_drc_suspend:
 ...
 null_op:
		...
		GSH_AUTO_TRACEPOINT(nfs_rpc, op_start, TRACE_DEBUG,
...
enum xprt_stat nfs_rpc_valid_NFS(struct svc_req *req)
{
	...
	GSH_AUTO_TRACEPOINT(nfs_rpc, valid, TRACE_DEBUG,
		"Valid nfs req. xprt_ptr: {}, cb_prog: {}, cb_vers: {}"
		"cb_proc: {}", reqdata->svc.rq_xprt, req->rq_msg.cb_prog,

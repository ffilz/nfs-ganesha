...
void dynamic_metrics__observe_nfs_request(UNUSED const char *operation,
					  UNUSED nsecs_elapsed_t request_time,
					  UNUSED const char *version,
					  UNUSED const char *status_label,
					  UNUSED export_id_t export_id,
					  UNUSED const char *client_ip)
{
}

void dynamic_metrics__observe_nfs_io(UNUSED size_t bytes_requested,
				     UNUSED size_t bytes_transferred,
				     UNUSED bool is_write,
				     UNUSED export_id_t export_id,
				     UNUSED const char *client_ip)
{
}

void dynamic_metrics__mdcache_cache_hit(UNUSED const char *operation,
					UNUSED export_id_t export_id)
{
}

void dynamic_metrics__mdcache_cache_miss(UNUSED const char *operation,
					 UNUSED export_id_t export_id)
{
}

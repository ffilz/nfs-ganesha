...
#
# ganesha_logrotate_mgr.py - commandline tool for managing nfs-ganesha
# logroration.
#
...
#
# Author: Prabhu Murugesan <prabhu.murugesan1@ibm.com>
#-*- coding: utf-8 -*-
#
...
class LogRotateManager:
    ...
    def get_os_type(self):
        ...
        if "ubuntu" in dist:
            return "ubuntu"
        elif "centos" in dist or "red hat" in dist or "rhel" in dist:
            return "rhel"
        else:
            return "other"
